...
{
	public partial class SafetySystem : Form
	{
		public SafetySystem()
		{
			InitializeComponent();
		...
		private void worker_ProcessChanged()
		{
			Action action = () =>
			{
				try
				{
					var httpWebRequest = (HttpWebRequest)WebRequest.Create("http://" + textBox_server.Text + "/Thingworx/Things/" + textBox_thing.Text + "/Services/" + textBox_service.Text + "?method=post&appKey=" + textBox_key.Text + "&d1=" + textBox_range_1.Text + "&d2=" + textBox_range_2.Text + "&d3=" + textBox_range_3.Text);
		...
		{
			textBox_range_1.Text = "320";
			textBox_range_2.Text = "320";
			textBox_range_3.Text = "320";
		}

		private void button_test_2_Click(object sender, EventArgs e)
		{
			textBox_range_1.Text = "50";
			textBox_range_2.Text = "50";
			textBox_range_3.Text = "50";
		}

		private void button_test_3_Click(object sender, EventArgs e)
		{
			textBox_range_1.Text = "50";
			textBox_range_2.Text = "180";
			textBox_range_3.Text = "180";
		}

		private void button_test_4_Click(object sender, EventArgs e)
		{
			textBox_range_1.Text = "200";
			textBox_range_2.Text = "120";
			textBox_range_3.Text = "70";
		}
	}
}
